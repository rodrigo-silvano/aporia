# APORIA product qualification RC4 diagnostic cycle
...
RC4 preserves RC1, RC2 and RC3 unchanged and uses a fresh corpus, participant-runner commitment, schedules and
...
This cycle is deliberately diagnostic: it re-runs only the RC3 failure families to calibrate the
evidenced-violation judge contract and the compact output budget. Its results cannot seal the final
release candidate. A fresh, independent, full blind run remains mandatory after these targeted gates pass.
...
Subjective critical or repeated-error judgments, and any false longitudinal safety invariant, receive
two additional blind judgments. Numeric quality scores use the median; critical and exact safety
invariants are binary and require a 2-of-3 majority. Deterministic HIRT/tool and effect gates remain unchanged.
