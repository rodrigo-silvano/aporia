...
RUN_ID = "APORIA_PRODUCT_RC2_RUN_001"
RUN_SEED = 824_349_407
...
def main() -> None:
    ...
    manifest = {
        ...
        "product_contract_version": "aporia-product-rc2-v1",
        "g8_consumed": False,
    }
    mapping = {"arm-jade": "core_without_aporia", "arm-violet": "core_with_aporia_product_candidate"}
    lock = {
        "run_id": RUN_ID,
