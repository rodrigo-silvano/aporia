...
def main() -> None:
    ...
    if c0["repeated_error_rate"] <= 0 or 1.0 - ratio(candidate["repeated_error_rate"], c0["repeated_error_rate"]) < 0.25:
    ...
    report = {
        ...
        "deltas": {
            ...
            "repeated_error_reduction": 1.0 - ratio(candidate["repeated_error_rate"], c0["repeated_error_rate"]),
