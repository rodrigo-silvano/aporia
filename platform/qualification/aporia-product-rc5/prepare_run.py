...
RUN_ID = "APORIA_PRODUCT_RC5_RUN_001"
RUN_SEED = 827_349_419
...
def main() -> None:
    ...
    manifest = {
        ...
        "product_contract_version": "aporia-product-rc5-v1",
        "g8_consumed": False,
    }
    mapping = {"arm-orchid": "core_without_aporia", "arm-slate": "core_with_aporia_product_candidate"}
    lock = {
        "run_id": RUN_ID,
