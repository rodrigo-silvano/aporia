# APORIA product qualification RC5
...
RC5 preserves RC1 through RC4 unchanged and uses a fresh corpus, participant-runner commitment, schedules and
...
RC5 is the fresh independent confirmation after the RC4 targeted diagnostics. It must execute the
complete blinded corpus and cannot reuse participant or judge outputs from any prior cycle.
